        ...
        <div className="grid grid-cols-7 gap-1 sm:gap-2">
          {days.map((d) => {
            ...
            return (
              <div
                key={key}
                className="relative flex aspect-square min-h-[2.1rem] items-center justify-center rounded-full text-[11px] font-medium transition-transform hover:scale-105 sm:text-[13px]"
